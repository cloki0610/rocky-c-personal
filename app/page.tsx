...
export default function Home() {
  return (
    <main className="sm:px-16 px-6 absolute inset-0 max-w-7xl mx-auto flex flex-row md:items-center gap-5 pt-[150px] md:pt-0">
      <div>
        <motion.h1
        ...
        >
          Hi, I&apos;m{" "}
          <span className="text-[#8d6e63] site-title">Rocky.C</span>
        </motion.h1>
        <motion.p
