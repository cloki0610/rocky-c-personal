...
import type { ArenaScreen, ClassId, KeyState, World, UseEndlessArenaResult } from "../interfaces/EndlessArenaTypes";
...
export default function useEndlessArena(): UseEndlessArenaResult {
    ...
    return { screen, world: world.current, boardRef, scale, best, startGame, changeFighter };
}
